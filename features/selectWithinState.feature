Feature: Opportunity Object
    Scenario:Select Within State in Taxation filed in Opportunity
        ...
        And I click on the element "Taxation Dropdown" and select the option with the text "Within State"
        And I expect that the element "Taxation Dropdown" contains the text "Within State"