Feature: Opportunity Object
    Scenario:Set Expenses for US call
        ...
        And I enter the value "800" for the element "PST Shift Expense"
        And I enter the value "1600" for the element "US Call Expense"
