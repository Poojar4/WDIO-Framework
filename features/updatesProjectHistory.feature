Feature:Invoices Object
    Scenario:Updates should be reflected in Project History
        ...
        And I move to element "Project History"
        ...
        And I expect that the element "Project History Page"contains the text "Project History"
