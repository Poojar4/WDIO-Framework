Feature:Opportunity Object
    Scenario: Creating Opportunity Record Entering Mandatory Fields and Verify Save Button
    ...
    # Scenario: Creating Opportunity Record Entering Mandatory Fields and Verify Save and New Button
    #     Given I open the site "/lightning/o/Account/list?filterName=__Recent"
    #     And I expect the url to contain "Account"
    #     When I wait on element "Opportunity Tab" to be displayed
    #     And I move to element "Opportunity Tab"
    ...
    # Scenario: Creating Opportunity Record Entering Mandatory Fields and Verify Cancel Button
    #     Given I open the site "/lightning/o/Account/list?filterName=__Recent"
    #     And I expect the url to contain "Account"
    #     When I wait on element "Opportunity Tab" to be displayed
    #     And I move to element "Opportunity Tab"
