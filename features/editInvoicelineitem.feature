Feature:Invoices Object
    Scenario:Edit created InvoiceLineItems
        ...
        And I click on element "Invoice Related"
        And I wait on element "Invoicelineitems" to be displayed
        And I click on the element "Invoicelineitem Dropdown"
        And I click on the element "Invoicelineitem Edit Button"
        And I wait on element "Edit Invoicelineitem Page" to be displayed
        And I expect that the element "Edit Invoicelineitem Page" contains the text "Edit"
        And I enter the value "Trishika" for the element "Employee"
        And I enter the value "31" for the element "No Of Working Days"
        And I enter the value "5" for the element "Invoicelineitem US Call"
        And I enter the value "4" for the element "Invoicelineitem Night Shift Call"
        And I enter the value "3" for the element "Invoicelineitem PST Shift"
        And I enter the value "2" for the element "Invoicelineitem Weekend"
        ...
        And I expect that the element "Invoicelineitem Toast Message" contains the text "saved"

    Scenario:Edit created InvoiceLineItems and Verify Save and New
        Given I open the site "/lightning/o/Account/list?filterName=__Recent"
        And I expect the url to contain "Account"
        When I wait on element "Opportunity Tab" to be displayed
        And I move to element "Opportunity Tab"
        ...
        And I enter the value "3" for the element "Invoicelineitem PST Shift"
        And I enter the value "2" for the element "Invoicelineitem Weekend"
        And I wait on element "Edit Invoicelineitem Save and New Button" to be enabled
        And I click on the element "Edit Invoicelineitem Save and New Button"
        And I wait on element "Invoicelineitem Toast Message" to be displayed
        And I expect that the element "Invoicelineitem Toast Message" contains the text "saved"
        And I wait on element "New Invoicelineitem Page" to be enabled
        And I expect that the element "New Invoicelineitem Page" contains the text "New InvoiceLineItem"

    Scenario:Edit created InvoiceLineItems and Verify Cancel
        Given I open the site "/lightning/o/Account/list?filterName=__Recent"
        And I expect the url to contain "Account"
        When I wait on element "Opportunity Tab" to be displayed
        And I move to element "Opportunity Tab"
        ...
        And I enter the value "3" for the element "Invoicelineitem PST Shift"
        And I enter the value "2" for the element "Invoicelineitem Weekend"
        And I wait on element "Edit Invoicelineitem Cancel Button" to be enabled
        And I click on the element "Edit Invoicelineitem Cancel Button"
        And I wait on element "Invoicelineitems" to be displayed
        And I expect that the element "Invoicelineitems" contains the text "Invoicelineitems"
