Feature:Opportunity Object
    Scenario:Generate Multiple Invoice for one Opportunity
        ...
        And I select the option with text "2023" for the element "Invoice Year Dropdown"
        ...
        And I enter the value "31-Jan-2023" for the element "Invoice Date"
